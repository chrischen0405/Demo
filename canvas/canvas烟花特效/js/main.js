...
function Fire(x, y) {
    ...
    this.speedX = ranFlag() * random(0, 3);//使火花从随机方向打开
    this.speedY = ranFlag() * random(0, 3);
    this.tail = [];
...
function ranColor(num) {
    color = num.toString(16);//生成ffffff以内16进制数
